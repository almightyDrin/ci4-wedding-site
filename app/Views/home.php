...
<head>
    ...
    <title>Aldrin & Janine Wedding</title>
    <link href="assets/css/themify/themify.css" rel="stylesheet">
    ...
    <link href="assets/css/swiper/swiper.min.css" rel="stylesheet">
    <link href="assets/css/select/nice-select.css" rel="stylesheet">
    <link href="assets/css/magnific/magnific-popup.css" rel="stylesheet">
    <link href="assets/css/fancybox/jquery.fancybox.css" rel="stylesheet">
    <link href="assets/css/odometer/odometer-theme-default.css" rel="stylesheet">
    <link href="assets/css/jquery/jquery-ui.css" rel="stylesheet">
...
<body>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="navbar-header py-3">
                                    <small><a class="navbar-brand" href="index.html" style="font-size: 30px; overflow-wrap: break-word; text-wrap: auto;">#Janine&DrinTiesTheKnot</a></small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-12">
                                <div class="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="400" class="slide-text wow fadeInUp"
                                        ...
                                        <p>We Are Getting Married December 22,2024</p>
                                    </div>
            ...
            <div class="static-hero-right">
                <div class="static-hero-img scene" id="scene">
                    <div class="static-hero-img-inner">
                        <img class="zoom" src="assets/images/couple/main.png" alt="">
                        ...
                        <div class="col col-md-12 col-12">
                            <div class="couple-item-wrap pointparallax">
                                <div class="couple-img-wrap">
                                    <div class="couple-common point__item" style="z-index: 1;" data-position="left-top" data-point="middle"
                                        data-path="125">
                                        <div class="couple-img">
                                            <img src="assets/images/couple/ring1.png" alt="">
                                        </div>
                                    </div>
                                    <div class="couple-common point__item" data-position="right" data-point="middle"
                                        data-path="125">
                                        <div class="couple-img">
                                            <img src="assets/images/couple/ring2.png" alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="wpo-story-wrap">
                        ...
                        <div class="row align-items-center">
                            <div class="col col-lg-6 col-12">
                                <div class="wpo-story-img">
                                    <img src="assets/images/couple/we-meet.png" alt="">
                                </div>
                            </div>
                            <div class="col col-lg-6 col-12">
                                <div class="wpo-story-content wow flipInX" data-wow-duration="1000ms">
                                    ...
                                    <h2>How we meet</h2>
                                    <p>We met at school as college schoolmates. She was a Management student, and I was a Computer Science student. Although we weren't in the same school building, our mutual friends brought us together, We started as friends and spent almost a year getting to know each other. Over time, our friendship grew deeper, and we eventually fell in love. and that's how our story began.</p>
                                    <div class="flower">
                    ...
                    <div class="wpo-story-item">
                        <div class="row align-items-center">
                            <div class="col col-lg-6 col-12 order-lg-2 order-1">
                                <div class="wpo-story-img">
                                    <img src="assets/images/couple/proposal.png" alt="">
                                </div>
                            </div>
                            <div class="col col-lg-6 col-12 order-lg-1 order-2">
                                <div class="wpo-story-content wow flipInX" data-wow-duration="1000ms">
                                    ...
                                    <p>The most beautiful thing happened. I proposed, and she said YES! Words can't describe the overwhelming emotions we felt in that moment. From being strangers to friends, and then falling deeply in love, our journey has been nothing short of magical.

                                        This moment marks the beginning of a new chapter in our lives, one filled with love, commitment, and dreams we’ll build together.</p>
                                    <div class="flower">
                    ...
                    <div class="wpo-story-item">
                        <div class="row align-items-center">
                            <div class="col col-lg-6 col-12">
                                <div class="wpo-story-img">
                                    <img src="assets/images/couple/prenup.png" alt="">
                                </div>
                            </div>
                            <div class="col col-lg-6 col-12">
                                <div class="wpo-story-content wow flipInX" data-wow-duration="1000ms">
                                    ...
                                    <h2>Our Prenup Day</h2>
                                    <p>We were so worried that our prenup shoot wouldn’t happen because of the bad weather. But with God’s grace and blessings, not even a storm could stop our special day.

                                        Just when we thought we might have to reschedule, the clouds cleared, and the sun broke through. It felt like a sign, reminding us that no matter what challenges come our way, with faith and hope, everything will fall into place.
                                        
                                        Grateful for this day, the perfect weather, and all the love and support around us. This is just the beginning of the blessings we know will be with us on our journey together!</p>
                                    <div class="flower">
                                        <img src="assets/images/story/flower.svg" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="portfolio-grids gallery-container clearfix portfolio-slide owl-carousel">
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/1.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/1.png" alt class="img img-responsive">
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/JSN02777.jpg" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/JSN02777.jpg" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/2.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/2.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/JSN02789.jpg" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/JSN02789.jpg" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/3.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/3.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/4.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/4.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/5.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/5.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/6.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/6.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/JSN03288.jpg" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/JSN03288.jpg" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/7.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/7.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/8.png" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/8.png" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                            ...
                            <div class="grid">
                                <div class="img-holder">
                                    <a href="assets/images/gallery/JSN04203.jpg" class="fancybox"
                                        data-fancybox-group="gall-1">
                                        <img src="assets/images/gallery/JSN04203.jpg" alt class="img img-responsive">
                                        <div class="hover-content">
                                            <i class="ti-plus"></i>
                                        </div>
                                    </a>
                    ...
                    <div class="row">
                            ...
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1000ms">
                                <div class="wpo-team-img-wrap">
                                    <div class="wpo-team-img"
                                        style="mask-image: url(./assets/images/mask-1.svg); -webkit-mask-image: url(./assets/images/mask-1.svg);">
                                        <img src="https://wpocean.com/html/tf/habibi/assets/images/team/img-1.jpg" alt="">
                                    </div>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12 layer" data-depth="0.15">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1200ms">
                                <div class="wpo-team-img-wrap">
                                    <div class="wpo-team-img"
                                        style="mask-image: url(./assets/images/mask-2.svg); -webkit-mask-image: url(./assets/images/mask-2.svg);">
                                        <img src="https://wpocean.com/html/tf/habibi/assets/images/team/img-2.jpg" alt="">
                                    </div>
                                    <div class="team-shape">
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12 layer" data-depth="0.20">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1400ms">
                                <div class="wpo-team-img-wrap">
                                    <div class="wpo-team-img"
                                        style="mask-image: url(./assets/images/mask-3.svg); -webkit-mask-image: url(./assets/images/mask-3.svg);">
                                        <img src="https://wpocean.com/html/tf/habibi/assets/images/team/img-3.jpg" alt="">
                                    </div>
                                    <div class="team-shape">
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-6 col-12 layer" data-depth="0.25">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1600ms">
                                <div class="wpo-team-img-wrap">
                                    <div class="wpo-team-img"
                                        style="mask-image: url(./assets/images/mask-4.svg); -webkit-mask-image: url(./assets/images/mask-4.svg);">
                                        <img src="https://wpocean.com/html/tf/habibi/assets/images/team/img-4.jpg" alt="">
                                    </div>
                                    <div class="team-shape">
                        ...
                        <div class="wpo-contact-section-wrapper">
                            ...
                            <div class="wpo-contact-form-area">
                                <form method="post" class="contact-validation-active" id="contact-form-main">
                                    ...
                                    <div>
                                        <select name="guest" class="form-control">
                                            <option disabled="disabled" selected>What You Will be Attending</option>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-event-item wow fadeInUp" data-wow-duration="1000ms">
                                ...
                                <div class="wpo-event-text">
                                    ...
                                    <ul>
                                        <li>Sunday, Dec. 22, 2024 <br>
                                            4:00 PM – 6:00 PM</li>
                                        <li>Punta De Uian Beach Resort, Pundaquit, San Antonio Zambales</li>
                                        <!-- <li>+1 234-567-8910</li> -->
                                        <li> <a class="popup-gmaps"
                                                href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3855.0422436430513!2d120.0547527748239!3d14.934739668809302!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3395d0c8f9f61c43%3A0x860f2a689cf43a4d!2sPunta%20de%20Uian%20Beach%20Resort!5e0!3m2!1sen!2sph!4v1731938904308!5m2!1sen!2sph">See
                                                Location</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="wpo-event-item wow fadeInUp" data-wow-duration="1200ms">
                                ...
                                <div class="wpo-event-text">
                                    ...
                                    <ul>
                                        <li>Sunday, Dec. 22, 2024 <br>
                                            1:30 PM – 2:30 PM</li>
                                        <li>Saint William's School Parish, Central, San Marcelino Zambales</li>
                                        <!-- <li>+1 234-567-8910</li> -->
                                        <li> <a class="popup-gmaps"
                                                href="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d510.4403874711963!2d120.15651938994552!3d14.974248152008874!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3395d60256c1c1d3%3A0xecdecb8989e17b8!2sSt.%20William&#39;s%20Catholic%20Church!5e0!3m2!1sen!2sph!4v1731939043017!5m2!1sen!2sph">See
                                                Location</a></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <!-- <section class="wpo-blog-section section-padding">
            <div class="container">
                ...
                <div class="wpo-blog-items">
                    <div class="row">
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-blog-item wow fadeInUp" data-wow-duration="1000ms">
                                <div class="wpo-blog-img">
                                    <img src="https://wpocean.com/html/tf/habibi/assets/images/blog/img-1.jpg" alt="">
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-blog-item wow fadeInUp" data-wow-duration="1200ms">
                                <div class="wpo-blog-img">
                                    <img src="https://wpocean.com/html/tf/habibi/assets/images/blog/img-2.jpg" alt="">
                                </div>
                                <div class="wpo-blog-content">
                                    <ul>
                        ...
                        <div class="col col-lg-4 col-md-6 col-12">
                            <div class="wpo-blog-item wow fadeInUp" data-wow-duration="1400ms">
                                <div class="wpo-blog-img">
                                    <img src="https://wpocean.com/html/tf/habibi/assets/images/blog/img-3.jpg" alt="">
                                </div>
                                <div class="wpo-blog-content">
                                    <ul>
                    ...
                    <div class="b-shape-2">
                        <img src="https://wpocean.com/html/tf/habibi/assets/images/blog/shape-2.svg" alt="">
                    </div>
                </div> -->
            <!-- </div> end container -->
            <!-- <div class="b-shape">
                <img src="https://wpocean.com/html/tf/habibi/assets/images/blog/shape-1.svg" alt="">
            </div>
        </section> -->
                            ...
                            <div class="widget link-widget">
                                ...
                                <div class="link-wrap">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="mailto:aldrin.dagsaan@gmail.com">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <a class="logo" href="index.html">#Janine&DrinTiesTheKnot</a>
                                </div>
                        ...
                        <div class="col col-xl-3  col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget wpo-service-link-widget">
                                ...
                                <div class="contact-ft">
                                    <ul class="link-w">
                                        <li><a href="mailto:aldrin.dagsaan@gmail.com">aldrin.dagsaan@gmail.com</a></li>
                                        <li><a href="mailto:janineconcepcion5328@gmail.com">janineconcepcion5328@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script src="assets/js/modernizr/modernizr.custom.js"></script>
    <script src="assets/js/jquery/jquery.pointparallax.min.js"></script>
    <script src="assets/js/jquery/jquery-plugin-collection.js"></script>
    <script src="assets/js/animate/moving-animation.js"></script>
    <script src="assets/js/jquery/tilt.jquery.min.js"></script>
